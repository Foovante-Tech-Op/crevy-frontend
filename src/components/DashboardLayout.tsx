...
export const DashboardLayoutClient = ({
  ...
  return (
    // Mounted here rather than in DashboardHeader: the header is hidden on
    // /projects, /financials, /portfolio and six other route prefixes below,
    // and Cmd+K has to work on all of them.
    <CommandPaletteProvider role={(user?.role as TRole) ?? "project_developer"}>
      <SidebarProvider>
