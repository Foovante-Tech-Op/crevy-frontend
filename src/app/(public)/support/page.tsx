      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#0A2540]/10 border border-[#0A2540]/10 mb-20">
          <div className="bg-[#F8F8F9] p-10 hover:bg-[#F6F9FC] transition-colors group flex flex-col justify-between min-h-[280px]">
            <div>
              <div className="w-12 h-12 bg-[#F6F9FC] border border-[#0A2540]/10 flex items-center justify-center text-[#0A2540] mb-8 group-hover:bg-[#F38221] group-hover:text-[#F8F8F9] transition-colors">
            ...
            <div className="mt-8 pt-6 border-t border-[#0A2540]/10 flex items-center justify-between">
              ...
              <button
                type="button"
                className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#0A2540] hover:text-[#FF751F] transition-colors flex items-center gap-1"
              >
          ...
          <div className="bg-[#0A2540] text-[#F8F8F9] p-10 flex flex-col justify-between min-h-[280px] relative overflow-hidden">
            ...
            <div className="mt-8 pt-6 border-t border-[#F38221]/20 flex items-center justify-between relative z-10">
              <span className="text-sm font-mono font-bold text-[#FF751F]">
                +233 504 609 989
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                >
                  <div className="flex justify-between items-start gap-8">
                    ...
                    <div className="shrink-0 pt-1">
                      <div className="w-8 h-8 rounded-full border border-[#0A2540]/20 flex items-center justify-center text-[#0A2540]/40 group-hover:border-[#F38221] group-hover:text-[#F38221] transition-all">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="mt-8 p-6 bg-[#F6F9FC] border border-[#0A2540]/10">
              ...
              <button
                type="button"
                className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#0A2540] hover:text-[#F38221] transition-colors flex items-center gap-1 border-b border-[#F38221] pb-0.5 w-fit"
              >
